...
You must configure environment variables to hold your sunsynk username and password (the ones you use to login to https://sunsynk.net/). Configure the following environment variables:
